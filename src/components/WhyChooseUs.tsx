      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-2xl p-8 text-white">
            <h3 className="text-2xl font-bold mb-4">Ready to Experience the JP Interios Difference?</h3>
            <p className="text-amber-100 mb-6">Join thousands of happy homeowners who chose quality, reliability, and exceptional design.</p>
            <div className="flex flex-wrap justify-center gap-8 text-center">
              ...
              <div>
                ...
                <div className="text-amber-200 text-sm">Customer Satisfaction</div>
              </div>
              <div>
                <div className="text-3xl font-bold">50+</div>
                <div className="text-amber-200 text-sm">Design Awards</div>
              </div>
            </div>
          </div>
        </div>
